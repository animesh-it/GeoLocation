                            ...
                            <div class="col-md-12">
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="APIPassword" class="form-control" placeholder="Enter API Password">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="GeoCode" class="form-control" placeholder="Enter Geo Code">
                                        </div>
                                    </div>
                                    <div class="form-group">
