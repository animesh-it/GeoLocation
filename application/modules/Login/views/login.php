...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Central Authentication App | Login</title>
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <?php
            $formattributes = array('class'=>'login_form','method'=>'post');
            echo form_open(base_url().'Login', $formattributes);
            ?>
                ...
                <div class="form-actions">
                    <input type="submit" name="btnsubmit" value="Login" class="btn btn-block green uppercase" />
                </div>
            <?php echo form_close();?>
            <!-- END LOGIN FORM -->
        </div>
