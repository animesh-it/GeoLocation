...
class Users extends REST_Controller {
    ...
    public function getAccess_post(){
        ...
        if($userinfo->num_rows()>0){
            ...
            $data['userlog']['EmployeeID'] = $userinfo->row()->EmployeeID;
    ...
    public function checkInOut_post(){
        ...
        $data['checkaction']['UserID'] = $userid;
        $data['checkaction']['GeoCode'] = $geocode;
        $data['checkaction']['DateTime'] = $datetime;
        $data['checkaction']['Action'] = $action;
        $this->restservermodel->addCheckInOut($data['checkaction']);
        $data['checkresponse']['CODE']=0;
        $data['checkresponse']['MSG']='Successfully added the info';
        $this->response($data['checkresponse']);
    }
}
